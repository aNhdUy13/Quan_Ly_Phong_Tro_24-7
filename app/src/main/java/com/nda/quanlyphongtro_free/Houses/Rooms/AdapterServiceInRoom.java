...
public class AdapterServiceInRoom extends RecyclerView.Adapter<AdapterServiceInRoom.HolderAddHouse> {
    RoomsSystem context;
    List<Service> serviceList;

    public AdapterServiceInRoom(RoomsSystem context, List<Service> serviceList) {
